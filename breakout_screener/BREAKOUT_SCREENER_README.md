...
- **BOUNCE** *(tambahan, di luar spek asli ISAT/TMPO)* — saham yang menyentuh area **support** (bukan resistance) DAN menunjukkan tanda pembalikan (candle Doji/Hammer + RSI oversold < 35). Filosofinya beda dari 3 mode di atas: BOUNCE itu "beli kelemahan" (mean reversion), sedangkan RADAR/SIAGA/ENTRY itu "beli kekuatan" (momentum/trend following). Prioritas pengecekan: ENTRY > SIAGA > RADAR > BOUNCE — BOUNCE dicek paling akhir supaya gak menimpa sinyal breakout yang lebih kuat kalau kebetulan dua-duanya kena.
